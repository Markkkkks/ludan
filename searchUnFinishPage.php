...
<head>
	...
	<script type="text/javascript" src="js/searchUnFinish.js"charset="utf-8"></script>
			...
			<div id="innerContainer">
				<div id="record">
					<div class="mytab">
						...
						<label class="checkLabel" onclick="document.location='searchUnfinishPage.php';">未完成卤蛋</label>
						<label onclick="document.location='searchfinishPage.php';">已完成卤蛋</label>
							<div class="myPanel">
								<?php 
									require_once("searchUnFinish.php");
									searchUnFinish();
								 ?>
							</div>
						</div>
